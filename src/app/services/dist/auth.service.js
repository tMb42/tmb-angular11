...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.getAuthUser = function () {
        return this.http.get(this.serverUrl + "/userDetails").pipe(operators_1.catchError(this.handleError));
    };
    ...
    AuthService.prototype.updateUserProfile = function (profileData) {
        var _this = this;
    ...
    AuthService.prototype.loginWithSocialite = function (provider) {
        // console.log(provider);
        return this.http.get(this.serverUrl + "/auth/" + provider).pipe(operators_1.catchError(this.handleError));
    };
